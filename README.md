...
| Betfair Exchange (`betfair_exchange`) | Implemented | Yes | Yes (current/cleared account orders, funds, account details, statements, currency rates) | Yes | Guarded, off by default | No | Required | Exchange account/API keys | Region/KYC limited |
