...
| Matchbook (`matchbook`) | Implemented | Yes | Yes | Yes (matched bets) | Guarded, off by default | No | Required | Exchange account/API keys | Region/KYC limited |
