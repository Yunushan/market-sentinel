...
| Betfair Exchange (`betfair_exchange`) | Implemented | Yes | Yes (matched and cleared account orders) | Yes | Guarded, off by default | No | Required | Exchange account/API keys | Region/KYC limited |
