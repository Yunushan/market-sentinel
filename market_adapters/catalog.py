...
MARKET_CATALOG: Tuple[MarketMetadata, ...] = (
    ...
    MarketMetadata(
        ...
        description="Official Myriad Protocol API adapter for public question/market discovery, outcome prices, and dry-run quote payloads.",
    ...
    MarketMetadata(
        ...
        description="Official Gemini Prediction Markets API adapter for public event discovery, contracts, orderbooks, prices, and dry-run orders.",
    ...
    MarketMetadata(
        ...
        description="Official Predict.fun REST API adapter for market discovery, orderbooks, prices, and dry-run orders.",
    ...
    MarketMetadata(
        ...
        description="Official Betfair Exchange API adapter for authenticated market discovery, best-offer orderbooks, prices, and dry-run orders.",
